    ...
    <header className="sticky top-0 z-50 w-full bg-dark-black">
      <div className="container mx-auto flex h-24 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          <Button 
            asChild 
            className="hidden lg:inline-flex bg-lime-accent text-dark-black hover:bg-lime-accent/90 rounded-full px-6 py-3 font-bold"
          >
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-24 left-0 w-full bg-dark-black h-screen">
          <nav className="flex flex-col items-center gap-8 pt-16">
            ...
            <Button 
              asChild 
              className="mt-8 bg-lime-accent text-dark-black hover:bg-lime-accent/90 rounded-full px-8 py-4 font-bold text-lg"
            >
              <Link to="/contact">Je veux un devis</Link>
              </Button>
          </nav>
